...
(function () {
    ...
    setKeyScalingPanning, setKeyScalingRelease, setRelease, transposeSamples, processEvent, stopSustain, playNote, stopNote, allNotesOff, allNotesOffPart, update, hasScheduledSamples, reschedule, unschedule;
    ...
    reschedule = function (song) {
        var min = song.millis, max = min + (sequencer.bufferTime * 1000), 
        //max2 = min + 20,
        scheduledSamples = this.scheduledSamples, id, note, sample;
...
//# sourceMappingURL=instrument_methods.js.map