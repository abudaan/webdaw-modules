...
(function () {
    ...
    Instrument.prototype.parse = function () {
        var i, maxi, v, v1, v2, length, octave, note, noteName, noteNumber, buffer, id, data, subdata, update, sampleConfig, config = this.config, noteNameMode = config.notename_mode === undefined ? sequencer.noteNameMode : config.notename_mode, me = this;
    ...
    sequencer.createInstrument2 = function (config) {
        function executor(resolve, reject) {
            ...
            parseSamples(config.samples).then(function onFulfilled(samples) {
                //console.log(samples);
...
//# sourceMappingURL=instrument2.js.map