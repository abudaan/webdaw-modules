...
function audioEncoder() {
    ...
    function getInterleavedSamples(audioBuffer) {
        ...
        if (audioBuffer.numberOfChannels === 2) {
            var left = audioBuffer.getChannelData(0), right = audioBuffer.getChannelData(1), numFrames = left.length, interleaved = new Float32Array(numFrames), i, index = 0;
...
*/
//# sourceMappingURL=audio_encoder.js.map